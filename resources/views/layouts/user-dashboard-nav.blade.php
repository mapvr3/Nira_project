...
<div class="nav-scroller bg-white box-shadow">
    <nav class="nav nav-underline">
		...
		<a class="nav-link {{ Request::is('unresolve*') ? 'active' : '' }}" href="{{ url( '/unresolve') }} ">Unresolved_Tickets</a>
        <a class="nav-link {{ Request::is('admin/tickets*') ? 'active' : '' }}" href="{{ url( '/admin/tickets') }} ">All Tickets</a>
		
        <a class="nav-link {{ Request::is('admin/users*') ? 'active' : '' }}" href="{{ url( '/admin/users') }} ">Admins</a>
		<a class="nav-link {{ Request::is('admin/category*') ? 'active' : '' }}" href="{{ url( '/admin/category') }} ">Ticket_Categories</a>
        
        @else
        <a class="nav-link {{ Request::is('home*') ? 'active' : '' }}" href="{{ url( '/home') }} ">Dashboard</a>
        <a class="nav-link {{ Request::is('tickets*') ? 'active' : '' }}" href="{{ url( '/tickets') }} ">Open Ticket</a>
        <a class="nav-link {{ Request::is('mytickets*') ? 'active' : '' }}" href="{{ url( '/mytickets') }} ">My_Tickets</a>
        <a class="nav-link {{ Request::is('myresolved*') ? 'active' : '' }}" href="{{ url( '/myresolved') }} ">My_Resolved_Tickets</a>
        <a class="nav-link {{ Request::is('myunresolved*') ? 'active' : '' }}" href="{{ url( '/myunresolved') }} ">My_Unresolved_Tickets</a>
		<a class="nav-link {{ Request::is('unresolve*') ? 'active' : '' }}" href="{{ url( '/unresolve') }} ">Unresolved_Tickets</a>
        @endif
