                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}"
                                    placeholder="Akhil reddy" required autofocus> @if ($errors->has('name'))
                        ...
                        <div class="form-row">
                            <div class="col-md-8">
                                ...
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}"
                                    placeholder="Akhil@nira.com" required> @if ($errors->has('email'))
                                <span class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                ...
                                <input id="telephone" type="number" class="form-control{{ $errors->has('telephone') ? ' is-invalid' : '' }}" name="telephone"
                                    value="{{ old('telephone') }}" placeholder="1111111111" required> @if ($errors->has('telephone'))
                                <span class="invalid-feedback">
