                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td bgcolor="#ffffff" width="100" align="left">
                                            <a href="http://complaindesk.co">
                                                <img alt="Complain Desk Logo" src="https://complaindesk.herokuapp.com/img/logo.png" width="52" height="78" style="display: block; font-family: Helvetica, Arial, sans-serif; color: #666666; font-size: 16px;"
                                                    border="0">
                                            </a>
                                        </td>
                                                ...
                                                <tr>
                                                    <td class="padding-copy">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td>
                                                                    <img src="http://www.tallyerpsolutions.com/wp-content/uploads/services.png" border="0" alt="Support Image" style="display: block; padding: 0; color: #666666; text-decoration: none; font-family: Helvetica, arial, sans-serif; margin-left:90px;font-size: 16px; width: 330px; height: 200px;"
                                                                        class="img-max">
                                                                </td>
                                                            </tr>
                                                        </table>
                            ...
                            <table width="500" border="0" cellspacing="0" cellpadding="0" align="center" class="responsive-table">
                                <tr>
                                    <td align="center" valign="middle" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
                                        ...
                                        <a style="color: #666666; text-decoration: none;">Visit Our Website</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
