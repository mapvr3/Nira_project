...
Route::get('/unresolve', 'FaqsController@index');

//Route to display Page to Create Ticket
Route::get('/tickets', 'TicketsController@create');
//Route to Handle ticket Storage
Route::post('/tickets', 'TicketsController@store');
//Route to display authenticated User's all Tickets
Route::get('/mytickets', 'TicketsController@userTickets');
//Route to display more information on a single ticket
Route::get('/tickets/{ticket_id}', 'TicketsController@show');
//Route to display authenticated User's resolved Tickets
Route::get('/myresolved/', 'TicketResolve@userTickets');
//Route to display authenticated User's unresolved Tickets
Route::get('/myunresolved/', 'TicketUnResolve@userTickets'); 
...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function () {
    ...
    Route::post('public_ticket/{ticket_id}', 'TicketsController@ticketVisibilityPrivate');
    //Change Ticket Visibility to Private
    Route::post('private_ticket/{ticket_id}', 'TicketsController@ticketVisibilityPublic');
